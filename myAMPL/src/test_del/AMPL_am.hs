...
find_service (names,(n,Q_HPUT 1 (Q_GET (s,t,e,c)),Q_EMPTY):chs) = do
                    ...
                    let comm = "x-terminal-emulator -e \"bash -c ' echo Please enter a number ; echo $$ ; nc localhost 44447 ' \" "
                    --let comm = "terminator -e \"bash -c ' echo Please enter a number ; echo $$ ; nc localhost 44447 ' \" "
                    x <- runCommand $ comm 
